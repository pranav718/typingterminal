...
function PracticeContent() {
  ...
  const currentBook = currentSampleBook 
    ? { title: `${currentSampleBook.title} by ${currentSampleBook.author}`, totalPassages: currentSampleBook.passages.length }
    : currentBookData 
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h3 className="text-base md:text-lg font-semibold text-matrix-primary">
                    {currentBook.title}
                  </h3>
                </div>
